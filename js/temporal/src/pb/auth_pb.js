...
goog.exportSymbol('proto.auth.UpdateReq.DataTier', null, global);
 ...
 * @constructor
 */
proto.auth.UpdateReq.DataTier = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.auth.UpdateReq.DataTier, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.auth.UpdateReq.DataTier.displayName = 'proto.auth.UpdateReq.DataTier';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.auth.UpdateReq.toObject = function(includeInstance, msg) {
  var obj = {
    ...
    dataTierChange: (f = msg.getDataTierChange()) && proto.auth.UpdateReq.DataTier.toObject(includeInstance, f)
  };
...
proto.auth.UpdateReq.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new proto.auth.UpdateReq.DataTier;
      reader.readMessage(value,proto.auth.UpdateReq.DataTier.deserializeBinaryFromReader);
      msg.setDataTierChange(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.auth.UpdateReq.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getDataTierChange();
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.auth.UpdateReq.DataTier.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!Object}
 */
proto.auth.UpdateReq.DataTier.prototype.toObject = function(opt_includeInstance) {
  return proto.auth.UpdateReq.DataTier.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.auth.UpdateReq.DataTier} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.auth.UpdateReq.DataTier.toObject = function(includeInstance, msg) {
  var obj = {
    newTier: jspb.Message.getFieldWithDefault(msg, 1, 0)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.auth.UpdateReq.DataTier}
 */
proto.auth.UpdateReq.DataTier.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.auth.UpdateReq.DataTier;
  return proto.auth.UpdateReq.DataTier.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.auth.UpdateReq.DataTier} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.auth.UpdateReq.DataTier}
 */
proto.auth.UpdateReq.DataTier.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.auth.UpdateReq.DataTier.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.auth.UpdateReq.DataTier.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.auth.UpdateReq.DataTier} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.auth.UpdateReq.DataTier.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 */
proto.auth.UpdateReq.DataTier.prototype.getNewTier = function() {
  return /** @type {!proto.auth.Tier} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/** @param {!proto.auth.Tier} value */
proto.auth.UpdateReq.DataTier.prototype.setNewTier = function(value) {
  jspb.Message.setProto3EnumField(this, 1, value);
};
...
/**
 * optional DataTier data_tier_change = 2;
 * @return {?proto.auth.UpdateReq.DataTier}
 */
proto.auth.UpdateReq.prototype.getDataTierChange = function() {
  return /** @type{?proto.auth.UpdateReq.DataTier} */ (
    jspb.Message.getWrapperField(this, proto.auth.UpdateReq.DataTier, 2));
};


/** @param {?proto.auth.UpdateReq.DataTier|undefined} value */
proto.auth.UpdateReq.prototype.setDataTierChange = function(value) {
 ...
 * Clears the message field making it undefined.
 */
proto.auth.UpdateReq.prototype.clearDataTierChange = function() {
  this.setDataTierChange(undefined);
};
 ...
 * @return {boolean}
 */
proto.auth.UpdateReq.prototype.hasDataTierChange = function() {
